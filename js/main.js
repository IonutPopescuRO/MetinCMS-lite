		...
		if($(window).width() < 1024){
			if($(window).width() < 800){
				$('#fullpage').fullpage({
					...
					'css3': false,
					anchors:['intro', 'registration', 'download', 'ranking', 'presentation'],
				...
				$('#fullpage').fullpage({
					...
					'navigationTooltips': ['intro', 'registration', 'Download', 'Das Spiel', 'presentation'],
			...
			$('#fullpage').fullpage({
				...
				'showActiveTooltip':false,
				'navigationPosition': 'right',
				'navigationTooltips': ['intro', 'Înregistrare', 'Descarcă', 'Clasament', 'Prezentare'],
